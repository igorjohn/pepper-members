...
<template>
    ...
    <div class="bg-gray-800 rounded-md p-5 w-full border border-gray-700 mt-6">
        <div class="flex space-x-2 justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="flex-none fill-none text-indigo-300 h-5 w-5">
    ...
    <div class="py-10">
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-4 gap-4">
            <CardCourse
                :isPublished="false"
                img="https://nerdreactor.com/wp-content/uploads/2017/09/The-Walking-Dead-_S8_14x48BB_REF1-thumb.jpg"
                title="Teste" />
            <CardCourse
                :isPublished="true"
                img="https://wallpaperset.com/w/full/3/f/d/22523.jpg"
                title="House M.D" />
            <CardCourse
                :isPublished="true"
                img="https://ostatniatawerna.pl/wp-content/uploads/2022/07/twd.jpg"
                title="Walking dead season 7" />
        </div>
    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mt-1">
                                        <textarea
                                            ...
                                            name="about"
                                            rows="3"
                                            class="border border-gray-300 bg-white text-gray-700 text-sm placeholder-gray-400 focus:border-indigo-500 active:border-primary w-full rounded-md py-3 px-3 font-medium outline-none transition disabled:cursor-default disabled:bg-[#F5F7FD]"
